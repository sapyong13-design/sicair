...
<div class="text-center py-5">
    <div style="font-size: 6rem; font-weight: 900; color: var(--sh-primary, #166534); opacity: 0.15; line-height: 1;">404</div>
    <div style="margin-top: -1rem;">
        <i class="ti ti-file-search" style="font-size: 4rem; color: var(--sh-primary, #166534); opacity: 0.5;"></i>
    </div>
